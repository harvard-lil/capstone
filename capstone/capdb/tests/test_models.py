...
def test_sync_case_body_cache(reset_sequences, case, elasticsearch, case_factory):
    ...
    assert xml_equal(case.body_cache.html,
        ...
        '  </section>\n'
        '  <article class="opinion" data-type="majority">\n'
        f'    <p id="b83-6">Foo v. Bar, <a href="/us/1/1/" class="citation" data-index="0" data-case-ids="{target_case.id}">1 U.S. 1</a>. Case text 2</p>\n'
    ...
    assert xml_equal(case.body_cache.xml,
        ...
        f'    <p id="b83-6">Foo v. Bar, <extracted-citation url="/us/1/1/" index="0" case-ids="{target_case.id}">1 U.S. 1</extracted-citation>. Case text 2</p>\n'
        '    <footnote label="1">\n'
        '      <p id="b83-11">Case text 3</p>\n'
        '    </footnote>\n'
        '  </opinion>\n'
