...
reporter_field_map= {'id': 'id', 'state': 'jurisdiction', 'reporter': 'full_name', 'short': 'short_name', 'start_date': 'start_year', 'end_date': 'end_year', 'volumes': 'volume_count', 'created_at': 'created_at', 'updated_at': 'updated_at', 'notes': 'notes'} 
