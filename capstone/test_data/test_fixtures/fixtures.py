...
@pytest.fixture
def ingest_django_fixtures():
    fabfile.ingest_fixtures()


@pytest.fixture
def ingest_volumes(ingest_django_fixtures):
    VolumeMetadata.objects.update(ingest_status='to_ingest')
    VolumeXML.objects.all().delete()
